...
// 1. นำเข้า ModalConfirm มาใช้แทนของเดิม
...
<template>
  <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
    <h2 class="text-lg mb-6">จำนวนเงินคงเหลือ {{ bankStore.balance.toLocaleString() }} บาท</h2>
